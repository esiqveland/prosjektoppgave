...
For comparison between the two programs, we created a test set of 100,000 queries. We then ran this test set against the reference MacBook computer, and on the pi, both for Python and {C}. The results are given in Table \ref{tbl:runtimes_ports}.
...
\begin{table}[h]
	...
	\hline
	\end{tabular}
	\caption{Runtimes for C and Python code on 100,000 queries.}
