...
As we can see in Table \ref{tab:cluster_worker_req_watt} we are able to achieve 242 requests per second per watt.
This is an increase of 54\%. This follows now utilizing all the workers fully as well as having one extra worker pulling its weight instead of doing load distribution.
